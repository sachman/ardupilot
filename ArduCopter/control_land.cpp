...
void Copter::land_run_vertical_control(bool pause_descent)
{
    ...
    if (!pause_descent) {
        ...
        // Compute a vertical velocity demand such that the vehicle approaches g2.land_alt_low. Without the below constraint, this would cause the vehicle to hover at LAND_START_ALT.
        cmb_rate = AC_AttitudeControl::sqrt_controller(MAX(g2.land_alt_low,100)-alt_above_ground, g.p_alt_hold.kP(), pos_control->get_accel_z());
